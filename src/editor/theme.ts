...
export const chickenglassTheme = EditorView.theme({
  ...
  ".cm-content": {
    ...
    maxWidth: "720px",
    marginLeft: "auto",      // push content toward center when extra space is available
    marginRight: "max(224px, calc((100% - 720px) / 2))", // reserve sidenote column, balance when wide
    overflow: "visible",
  },
  ".cm-gutters": {
    display: "none",
