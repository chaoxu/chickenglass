...
For two edges $\set{a,b}$ and $\set{c,d}$ defined over integers, it is *independent* if $[a,b]\cap [c,d]= \emptyset$. A set of edges is *independent* if the edges are pairwise independent.
