...
\[
f_k(x) = x `\prod`{=tex}\_{i=1}\^{k} `\left`{=tex}(1+`\frac{1}{p_j-1}`{=tex}`\right`{=tex})
\]
by induction.
...
\[
1+`\sum`{=tex}*{j=1}\^k `\frac{1}{p_j}`{=tex} `\prod`{=tex}*{i=1}\^j `\left`{=tex}(1+`\frac{1}{p_i -1}`{=tex}`\right`{=tex}) = `\prod`{=tex}\_{j=1}\^k `\left`{=tex}(1+`\frac{1}{p_j-1}`{=tex}`\right`{=tex})
\]
:::
...
::: Theorem
\[
f_k(x) = x `\prod`{=tex}\_{i=1}\^{k} `\left`{=tex}(1+`\frac{1}{p_i-1}`{=tex}`\right`{=tex})
\]
:::
