...
\[
`\sum`{=tex}\_{i=1}\^n x_i a_i = 1
\]
such that for all $1\leq i\leq n-1$,
\[
\|x_i\|`\leq `{=tex}`\frac{g_{i+1}}{2g_i}`{=tex}
\]
...
\[
`\sum`{=tex}*{i`\in `{=tex}I} \|x_i\| `\leq `{=tex}`\frac{1}{2}`{=tex} `\sum`{=tex}*{i`\in `{=tex}I} `\frac{g_{i+1}}{g_i}`{=tex} `\leq `{=tex}`\frac{g_{j+1}}{2}`{=tex} + `\frac{1}{2}`{=tex} `\sum`{=tex}*{i`\in `{=tex}I, i`\neq `{=tex}j} g*{i+1} - g_i `\leq `{=tex}`\frac{g_{j+1}}{2}`{=tex} + `\frac{1}{2}`{=tex} `\sum`{=tex}*{i=j+1}\^{n-1} g*{i+1}-g_i = `\frac{1}{2}`{=tex}g_n = `\frac{\min(a)}{2}`{=tex}.
\]

\[
\|x\| = `\sum`{=tex}*{i=1}\^n \|x_i\| = \|x_n\| + `\sum`{=tex}*{i`\in `{=tex}I} \|x_i\| `\leq `{=tex}`\frac{\min(a)+\max(a)}{2}`{=tex}
\]
:::
