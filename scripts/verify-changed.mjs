...
const AREA_TESTS = [
  ...
  },
  {
    command: [
      ...
      "test:focused",
      "--",
      "src/render/reference-render-routing-basic.test.ts",
      "src/render/reference-render-routing-cluster.test.ts",
      "src/render/reference-render-edge.test.ts",
      "src/render/reference-render-perf.test.ts",
      "src/render/reference-render-plan.test.ts",
      "src/render/reference-render-focus.test.ts",
